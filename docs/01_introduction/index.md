...
TypeScratcherは、Scratch3のRender処理、Audio処理を組み込んだ、Scratch3風の動きを再現できるようにしたゲームエンジンです。<br>

![画像](/typescratcher_header.png)

Scratch3を愛する人間を代表して、Typescriptでプログラミングができるゲームエンジン『TypeScratcher』を作りました。
...
コード補完の恩恵をフル活用したく、Typescriptを使って実装しています。

それではTypeScratcherを楽しんでみてくださいね(:smile:)
